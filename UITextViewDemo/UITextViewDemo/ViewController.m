...
- (UITableViewCell *)arrangeTableView:(UITableView *)tableView
    ...
    CGRect textViewFrame = CGRectMake(cell.frame.origin.x + 5,
    ...
    [_tempTextViewArray addObject:[NSMutableDictionary dictionaryWithObject:textView.text
                                                                     forKey:[NSString stringWithFormat:@"%li" ,textView.tag]]];
    ...
    [cell setBackgroundColor:[UIColor colorWithRed:colorR
                                             green:colorG
                                              blue:colorB
                                             alpha:1.0f]];
    return cell;
